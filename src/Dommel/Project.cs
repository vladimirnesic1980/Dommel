...
namespace Dommel
{
    public static partial class DommelMapper
    {
        ...
        {
            QueryCacheKey cacheKey = new QueryCacheKey(QueryCacheType.Project, sqlBuilder, type);
        ...
        {
            QueryCacheKey cacheKey = new QueryCacheKey(QueryCacheType.ProjectAll, sqlBuilder, type);
            if (!QueryCache.TryGetValue(cacheKey, out var sql))
            {
